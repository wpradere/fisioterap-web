...
export default function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-olive to-sand py-16">
        <div className="max-w-7xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-brown to-brown text-white font-semibold rounded-lg hover:shadow-lg hover:-translate-y-0.5 transition-all"
                >
                  <Video size={20} />
                  Agendar Zoom
                </a>
            ...
            <div className="rounded-2xl p-8 shadow-2xl">
              <div className="relative aspect-[4/3] bg-gradient-to-br from-sand to-sand rounded-xl overflow-hidden">
                <Image
                  fill
                  src="/img2.png"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Masajes especializados para el tratamiento del dolor muscular y mejora de la circulación.",
              },
            ].map((service, index) => (
              <div
                key={index}
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-olive to-sand rounded-lg flex items-center justify-center text-white mb-4">
                  {service.icon}
                </div>
      ...
      <section
        id="sobre-mi"
        className="py-20 bg-gradient-to-br from-olive to-sand"
      >
        <div className="max-w-7xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-xl flex items-center justify-center text-gray-500">
              Tu Foto Profesional
            </div>
            <div>
      ...
      <section
        id="contacto"
        className="py-20 bg-gradient-to-r from-brown to-brown text-white text-center"
      >
