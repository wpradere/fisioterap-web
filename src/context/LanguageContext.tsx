...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.groups.goal3": "Co-parenting and Third Culture Parenting",
    ...
    "contact.addressValue": "Building 1A, Podium Level, Unit G-12 Masdar City, Abu Dhabi",
    ...
    "footer.address": "Address: Building 1A, Podium Level, Unit G-12",
  ...
  es: {
    ...
    "services.groups.goal3": "Co-crianza y Crianza de Tercera Cultura",
    ...
    "contact.addressValue": "Edificio 1A, Nivel Podio, Unidad G-12 Masdar City, Abu Dhabi",
    ...
    "footer.address": "Dirección: Edificio 1A, Nivel Podio, Unidad G-12",
    "footer.city": "Masdar City, Abu Dhabi",
