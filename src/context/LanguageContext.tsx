...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.intro1": "Welcome. I am Camila Barreto, a psychotherapist and family coach dedicated to providing caring, compassionate and deeply attuned emotional, behavioral and executive functioning support. My mission is to help families alleviate emotional pain while fostering a clearer, more profound awareness of themselves and their life experiences that supports meaningful connection and conscious transformation.",
    ...
    "services.family.goal1": "Navigating academic and social pressures during adolescence",
    ...
    "services.groups.intro": "Empowering parents and children with evidence based tools to overcome emotional and developmental changes and optimize collective functioning.",
    "services.groups.subtitle": "Common goals in groups coaching",
    "services.groups.goal1": "Navigating academic and social pressures during adolescence",
    "services.groups.goal2": "Developing growth mindset and healthy habits for emotional well-being",
    "services.groups.goal3": "Build family rituals and manage daily routines",
    "services.groups.goal4": "Build trust, empathy and safety among family members",
    "services.groups.goal5": "Adapting to life changes like separation, moving and recovery",
    "services.groups.goal6": "Addressing challenging behaviors such as defiance, bullying and isolation",

    // Packages
    "packages.title": "Packages",
    "packages.starter.title": "Starter",
    "packages.starter.description": "Gateway for those beginning their coaching journey. This package includes a family coaching assessment to identify specific short term and long term goals.",
    "packages.starter.price": "Three 60-minute sessions for 2800 AED",
    ...
    "packages.shortterm.price": "Six 60-minute sessions for 4800 AED",
    ...
    "packages.supportgroups.description": "For shorter-term goals and immediate transformation. This package provides a targeted action plan focusing on rapid skill development and specific recommendation to evoke immediate growth.",
  ...
  es: {
    ...
    "about.intro1": "Bienvenidos. Soy Camila Barreto, psicoterapeuta y coach familiar dedicada a proporcionar apoyo emocional, conductual y de funcionamiento ejecutivo con cuidado, compasión y profunda sintonía. Mi misión es ayudar a las familias a aliviar el dolor emocional mientras fomento una conciencia más clara y profunda de sí mismos y sus experiencias de vida que apoye la conexión significativa y la transformación consciente.",
    ...
    "services.groups.intro": "Empoderando a padres e hijos con herramientas basadas en evidencia para superar cambios emocionales y de desarrollo y optimizar el funcionamiento colectivo.",
    "services.groups.subtitle": "Objetivos comunes en coaching grupal",
    "services.groups.goal1": "Navegar presiones académicas y sociales durante la adolescencia",
    "services.groups.goal2": "Desarrollar mentalidad de crecimiento y hábitos saludables para el bienestar emocional",
    "services.groups.goal3": "Construir rituales familiares y gestionar rutinas diarias",
    "services.groups.goal4": "Construir confianza, empatía y seguridad entre miembros de la familia",
    "services.groups.goal5": "Adaptarse a cambios de vida como separación, mudanza y recuperación",
    "services.groups.goal6": "Abordar comportamientos desafiantes como desafío, acoso y aislamiento",
    ...
    "packages.supportgroups.description": "Para metas a corto plazo y transformación inmediata. Este paquete proporciona un plan de acción dirigido enfocado en el desarrollo rápido de habilidades y recomendaciones específicas para provocar un crecimiento inmediato.",
